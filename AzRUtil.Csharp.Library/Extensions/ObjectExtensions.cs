...
namespace AzRUtil.Csharp.Library.Extensions
{
    public static class ObjectExtensions
    {
        ...
        public static string ToObjectString<T>(this T obj)
        {
            var strNew = string.Empty;
        ...
        public static string ExportToXml<T>(this T obj, string path = "")
        {
            ...
            {
                path = AppConstant.StartupPath;
            }
            var writer = new XmlSerializer(typeof(T));
            var fileName = DateTime.UtcNow.ToString("yyyyMMddHHmmssfff") + ".xml";
        ...
        //private static bool HasAllEmptyProperties<T>()
        //{
        //    var type = typeof(T);
